  ...
  return (
    <Layout>
      ...
      <div className={style.bgImage}>
        <GatsbyImage className="bg-img-header" image={bgImage!} alt='bg' backgroundColor="red"/>
        <header>
          <h2>BBQ in 茅ヶ崎</h2>
        </header>
      ...
      <div className={style.container}>
        ...
        <p className={style.highlight}>茅ヶ崎の美しい環境の中で、美味しいものを食べて素敵な時間を過ごしましょう</p>
        ...
        <section>
          ...
          <BBQCardComponent title={`BBQ 機材レンタル `} subTitle={`BBQ Equipments`}>
            <div className={style.menuContainer}>
              ...
              <ul className={style.menuList}>
                ...
                <li className={style.menuTitle}>食器類 紙皿/箸/おしぼり/プラコップ</li>
                <li className={style.menuTitle}>その他 テープ/手袋/ゴミ袋</li>
              </ul>

              <div className={style.menuPriceOne}>1名様 <span className={style.tax}>税込 </span><span className={style.price}>2000円</span> <br/>4名様から受付</div>
              {/*  image */}
            </div>
          </BBQCardComponent>
          ...
          <BBQCardComponent title={`ビールサーバーレンタル`} subTitle={`Draft Beer Tap Tower & Barrels`}>
            <div className={style.flexColumnContainer}>
              <div className={style.menuItemDrink}>
                <div>
                  <div className={style.menuTitle}>カルスバーグ 10L樽</div>
                  <div className={style.menuTitleEnglish}>Carlsberg 10L樽</div>
                </div>
          ...
          <BBQCardComponent title={`食材セット`} subTitle={`BBQ FOOD`}>
            <div>
              <ul  className={style.menuList}>
                <li className={style.menuTitle}>鶏肉250g （ジャークチキン。レモンソース）</li>
              ...
              <div className={style.menuPriceOne}>1名様 <span className={style.tax}>税込 </span><span className={style.price}>税込2500円</span> <br/>4名様から受付</div>
          ...
          <BBQCardComponent title={`ドリンクセット`} subTitle={`DRINKS`}>
            <div>
              <ul className={style.menuList}>
                ...
                <li className={style.menuTitle}>チューハイ2本又はソフトドリンク2本（計4本セット）</li>
              </ul>

              <div className={style.menuPriceOne}>1名様 <span className={style.tax}>税込 </span><span className={style.price}>税込1000円</span> <br/>4名様から受付</div>
              {/*  image */}
            </div>
          </BBQCardComponent>
