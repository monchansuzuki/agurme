          ...
          <section>
            ...
            <BBQCardComponent title={`BBQ 機材レンタル `} subTitle={`BBQ Equipments`}>
              <div className={style.menuContainer}>
                ...
                <div className={style.menuPriceOne}>1名様 <span className={style.tax}>税込 </span><span
                  className={style.price}>2000円</span> <br/>4名様から受付
                </div>
                {/*  image */}
              </div>
            </BBQCardComponent>
            ...
            <BBQCardComponent title={`食材セット`} subTitle={`BBQ FOOD`}>
              <div>
                ...
                <div className={style.menuPriceOne}>1名様 <span className={style.tax}>税込 </span><span
                  className={style.price}>税込2500円</span> <br/>4名様から受付
                </div>
            ...
            <BBQCardComponent title={`ドリンクセット`} subTitle={`DRINKS`}>
              <div>
                ...
                <div className={style.menuPriceOne}>1名様 <span className={style.tax}>税込 </span><span
                  className={style.price}>税込1000円</span> <br/>4名様から受付
                </div>
                {/*  image */}
              </div>
            </BBQCardComponent>
