    ...
    <div className={style.container}>
      ...
      <div className={style.block}>
        ...
        <div className={style.flex}>
          <a href="tel:0467-73-7712" className={style.phone}>Tel: 0467-73-7712</a>
          <a href="tel:080-5378-7703" className={style.phone}>ENGLISH Tel: 080-5378-7703 </a>
        </div>
      </div>

      <div>
        <h5>
          ご予約・お間い合わせ時間 <br/>10:00 ~ 22:00
        </h5>
      </div>
