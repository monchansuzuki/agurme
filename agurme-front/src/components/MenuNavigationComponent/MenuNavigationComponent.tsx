...
export default function MenuNavigationComponent(
  props: MenuNavigationComponentProps
) {
  ...
  return (
    <ul className={`${style.container} ${props.className}`}>
      <li
        className={`${style.link} ${activeLink !== 1 || style.activeLink}`}
        onClick={() => handleNavigation(1)}
      >
        Pizza
      </li>
      <li
        className={`${style.link} ${activeLink !== 2 || style.activeLink}`}
        onClick={() => handleNavigation(2)}
      >
        Pasta
      </li>
      <li
        className={`${style.link} ${activeLink !== 3 || style.activeLink}`}
        onClick={() => handleNavigation(3)}
      >
        Second Piatto
      </li>
      <li
        className={`${style.link} ${activeLink !== 4 || style.activeLink}`}
        onClick={() => handleNavigation(4)}
      >
        AntiPasti
      </li>
      <li
        className={`${style.link} ${activeLink !== 5 || style.activeLink}`}
